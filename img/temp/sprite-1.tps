...
<data version="1.0">
    <struct type="Settings">
        ...
        <string>3.3.4</string>
        <key>fileName</key>
        <string>/Users/marcelo/htdocs/vitarella_site_novo/img/temp/sprite-1.tps</string>
        ...
        <map type="GFileNameMap">
            ...
            <struct type="DataFile">
                <key>name</key>
                <filename>sprite-1.css</filename>
            </struct>
        </map>
        <key>multiPack</key>
        <false/>
        ...
        <key>fileList</key>
        <array>
            <filename>banner-left.png</filename>
            <filename>banner-right.png</filename>
            <filename>busca-1.png</filename>
            <filename>facebook.png</filename>
            <filename>filtrar-receita.png</filename>
            <filename>google.png</filename>
            <filename>icon-aplicativo.png</filename>
            <filename>icon-contato.png</filename>
            <filename>icon-imprensa.png</filename>
            <filename>icon-produto.png</filename>
            <filename>icon-receita.png</filename>
            <filename>icon-sobre.png</filename>
            <filename>login-1.png</filename>
            <filename>play.png</filename>
            <filename>twitter.png</filename>
            <filename>ver-mais.png</filename>
            <filename>ver-todos-2.png</filename>
